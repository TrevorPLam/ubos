 ...
 * This function extracts the app creation logic for testability.
 * 
 * @param expressApp - Express app instance (optional, defaults to creating new one)
 * @returns Configured Express app and HTTP server
 */
export function createApp(expressApp?: express.Express) {
...
/**
 * Setup routes and error handling for the application.
 * This should be called after createApp() but before starting the server.
 */
export async function setupApplication(app: express.Express, server: any) {
